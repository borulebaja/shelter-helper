...
export const actions = { login(user) {
         ...
         deleteShelter(shelterId) {
           return function(dispatch, getState) {
             fetch(
               `http://localhost:3000/api/v1/shelters/${shelterId}`,
               {
                 method: "DELETE",
                 headers: {
                   Authorization: `Bearer ${localStorage.getItem(
         ...
         getShelterNeeds(shelter_id) {
           return function(dispatch, getState) {
             fetch(
               `http://localhost:3000/api/v1/shelters/${shelter_id}/needs`,
               {
                 headers: {
                   "Content-Type": "application/json",
                   Accept: "application/json"
         ...
         updateNeed(need, id, needId) {
           return function(dispatch, getState) {
             fetch(
               `http://localhost:3000/api/v1/shelters/${id}/needs/${needId}`,
               {
                 method: "PATCH",
                 headers: {
                   Authorization: `Bearer ${localStorage.getItem(
